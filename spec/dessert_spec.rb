...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cheesecake", "haha", chef) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["egg", "sugar", "egg", "creamcheese", "butter"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Anna the Great Baker")
      expect(cake.serve).to eq("Chef Anna the Great Baker has made 50 cakes!")
    end
  end
